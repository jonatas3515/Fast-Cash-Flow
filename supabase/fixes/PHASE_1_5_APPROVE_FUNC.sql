-- ==============================================================
-- FASE 1.5: CORRIGIR FUNÇÃO DE APROVAÇÃO
-- ==============================================================
...
BEGIN
  ...
  -- Pegar userid do admin (quem está aprovando vira o owner inicial? 
  -- CUIDADO: Se o admin aprova, o owner_id deveria ser NULL ou do próprio admin? 
  -- Geralmente criamos um placeholder ou usamos o próprio admin temporariamente 
  -- até o usuário logar, mas aqui vamos vincular ao admin por enquanto ou criar sem owner)
  
  -- Lógica original: vinculava ao current_user (admin). 
  -- Se o login depois busca por username, ok.
  ...
  INSERT INTO companies (
    ...
    req_row.company_name, -- Nome corrigido
    LOWER(approved_user),
    req_row.email,
    req_row.phone,
    req_row.address,
    req_row.cnpj,
    req_row.founded_on, -- Nome corrigido
    current_user_id,    -- Vincula ao admin inicialmente
  ...
  SET 
    status = 'approved',
    approved = true,
    approved_at = NOW(), -- Nome corrigido
    approved_username = approved_user,
    approved_temp_password = temp_pass, -- Nome corrigido
